...
export default async function CheckoutPage() {
  ...
  return (
    // 🎨 bg-background en lugar de bg-slate-950
    <main className="min-h-screen bg-background py-8 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground">Finalizar Pedido</h1>
          <p className="text-muted-foreground mt-1">Confirma tus datos para la recogida.</p>
        </div>
